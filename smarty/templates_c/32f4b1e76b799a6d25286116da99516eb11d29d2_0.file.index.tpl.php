<?php
/* Smarty version 3.1.30, created on 2017-11-05 08:30:09
  from "C:\wamp64\www\project_nhac\smarty\templates\body\index.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59fecc11a59431_63831004',
...
function content_59fecc11a59431_63831004 (Smarty_Internal_Template $_smarty_tpl) {
?>
                ...
                <div class="wrap-xep-hang col-12 col-md-3 col-lg-3 col-xl-3">
                    <div class="ca_si_viet_nam">
                        <a href="danh_Sach_ca_si.php">
                            <img style="width:90%" src="public/images/anhcasi/ca_si_viet_nam.jpg" />
                        </a>
                    </div>
                    <div class="nhung_bai_hit_moi">
                        <img style="width:90%" src="public/images/anhcasi/nhung_bai_hit_moi.jpg" />
                    </div>
                    <div class="nhac_phim">
                        <img style="width:90%" src="public/images/anhcasi/nhac_phim.jpg" />
                    </div>
                    <div class="nhac_hot">
                        <img style="width:90%" src="public/images/anhcasi/nhac_hot.jpg" />
                    </div>
